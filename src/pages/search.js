    ...
    return (
        <div>
            ...
            <div className="flex flex-col space-y-40 my-40 m-5 p-5">
                ...
                {buku.length > 0? (
                    <p className="text-center font-bold text-2xl">{buku.length} Buku Berhasil Ditemukan</p>
                ) : (
                    <p className="text-center font-bold text-2xl">Tidak Menemukan Buku Yang Sesuai Dengan Pencarian Anda</p>
                )}
